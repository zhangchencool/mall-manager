          ...
          <div class="form">
            <el-form ref="form" :model="addRuleForm" label-width="100px">
               <el-form-item label="添加方式">
                <el-radio v-model="addRuleForm.typeRadio" label="0" border>新增来源</el-radio>
                <el-radio v-model="addRuleForm.typeRadio" label="1" border>已知来源</el-radio>
               </el-form-item>
              <div v-if="addRuleForm.typeRadio == '0'">
                <el-form-item label="入口类型">
                  <el-radio v-model="addRuleForm.radio" label="0" >捐赠</el-radio>
                  <el-radio v-model="addRuleForm.radio" label="1" >下拨</el-radio>
                  <el-radio v-model="addRuleForm.radio" label="2" >采购</el-radio>
                  <el-radio v-model="addRuleForm.radio" label="3" >借用</el-radio>
                </el-form-item>
